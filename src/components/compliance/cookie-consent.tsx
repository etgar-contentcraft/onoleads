...
export function CookieConsent({ language = "he" }: { language?: Lang }) {
  ...
  return (
    <div
      className="fixed bottom-0 left-0 right-0 z-[90] animate-slide-up-spring"
      dir={isRtl ? "rtl" : "ltr"}
      role="dialog"
      aria-label={l.ariaLabel}
      aria-describedby="cookie-consent-description"
    >
      <div className="glass-backdrop border-t border-white/10 shadow-[var(--shadow-elevated)]">
        <div className="max-w-6xl mx-auto px-5 py-4 md:py-5">
          <div className="flex flex-col md:flex-row items-start md:items-center gap-4">
            {/* Icon with subtle glow */}
            <div className="hidden md:flex items-center justify-center w-10 h-10 rounded-xl bg-[#B8D900]/10 border border-[#B8D900]/15 shrink-0">
            ...
            <div className="flex-1 min-w-0">
              <p id="cookie-consent-description" className="text-white/75 text-sm leading-relaxed font-heebo">
                {l.text}
                <a
                  href="/privacy"
                  className="text-[#B8D900] hover:text-[#c8e920] hover:underline font-medium mx-1 transition-colors"
                  target="_blank"
            ...
            <div className="flex items-center gap-3 shrink-0 w-full md:w-auto">
              <button
                ...
                className="flex-1 md:flex-none px-5 py-2.5 rounded-xl border border-white/15 text-white/60 text-sm font-medium hover:bg-white/[0.08] hover:text-white hover:border-white/25 transition-all duration-300"
              ...
              <button
                ...
                className="flex-1 md:flex-none px-5 py-2.5 rounded-xl bg-[#B8D900] text-[#2a2628] text-sm font-bold hover:bg-[#c8e920] hover:shadow-[var(--shadow-green)] transition-all duration-300 hover:scale-[1.02] active:scale-[0.98]"
